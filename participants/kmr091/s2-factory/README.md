...
For: me and my team — anyone who needs to ground policy discussions in current developments.
Inputs: a policy area, a sub-topic for this run (a country, tool, or development), and a baseline (the date last checked, or a triggering event); optionally a document instead of, or alongside, a web search.
