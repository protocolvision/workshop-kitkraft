...
Job: run one of three generalized practice modes — a time-of-day reflection session, a single-question companion prompt, or a rhetorical-device writing drill — as one skill any agent can run, with the personal "Patch" branding stripped out.
For: who runs it.
