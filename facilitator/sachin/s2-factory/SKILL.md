...
## When to use
A user hands you a transcript or notes from a conversation with someone about how their team uses AI, and wants to know what stage they are at and what to do first. Also fits a workshop inventory file (`participants/<name>/s1-inventory/inventory.md`): treat it as the transcript.
