...
One folder per participant: `participants/<your-name>/kit/`, copied from `PARTICIPANT_TEMPLATE/`. Ship by the end of Session 2; fix what your triad's agent found overnight (`instructions/async-2.md`) and push v2. Private kits: content stays on your machine; the README here is a stub. There is no private repo.
