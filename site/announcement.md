...
**🧩 New workshop: AI Kitcraft — A Hands-On AI Tooling Workshop**
...
**Subject:** Build your first AI Kit — a hands-on workshop at the 2026 Protocol Symposium
...
2. a working grasp of the five-level AI Capability Maturity Model — enough to locate your organization and plan the next level up.
...
Foundations: the AI Capability Maturity Model (ai.protocolized.dev) · Sachin Benny, *AI, Tractors, and the Productivity Paradox*.
