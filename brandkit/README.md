...
> Copied into `protocolvision/kitcraft-2026` on 2026-09-11 from `rafaeldavid/protocolized-publications/protocolinstitute-brandkit/` (v1.2). It is here as the S2 example and a bridge target. The kit's own `README.md`, `llms.txt`, `brand.json` are the contract; the raw Google Drive export was left out because `assets/logos/` already holds those files.
