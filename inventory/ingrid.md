...
## Built / use
A ChatGPT project with our reporting template pasted in. Nothing shareable.

## Kit
Task 1, the funder report assembler: project update documents and a finance sheet extract in, the report in the funder's template with a reconciliation note out. Public.
