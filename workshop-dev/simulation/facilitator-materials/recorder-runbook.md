...
- That Discord display names in the diarized transcript match the handles in `personas/` (real day: the roster), or keep a name map in facilitator notes, not in the repo.
