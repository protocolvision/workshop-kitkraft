...
Two versions. The short one is read aloud at the top of S1 (by the facilitator opening the room; Rafa in S1) and repeated in one sentence at the top of S2–S4. The pinned version is Rafa's "Recording Policy FYI" in #workshop-kitkraft. Both are on the record; the read-aloud is itself in the S1 transcript.
