...
Lead: Rafa. Co-facilitator: Sachin (chat, recorder, repo). Cohort: 6, two triads. Cut from the 90-min outline: ice-breaker 15→9, situating 15→7, theory 20→14, exercise 30→17, close 5→7. Minute marks are from session start.

## Slide 1 — AI Kitcraft: Kit → Factory → Bridge (00:00)
...
> Note: recorder is already on (Sachin started it at 15:28). Say hello, keep it to one minute.

## Slide 2 — Consent (00:01)
...
> Note: seed with my own: water-rate PDFs, and the rule "the agent never converts units". Sachin gives his example second. Tomás will run long; cut at 90 s.

## Slide 4 — What this is not (00:12)
...
> Note: two minutes; one breath per bullet.

## Slide 5 — Frame: the Expanded Awareness 2×2 (00:14)
- Axes: **External / Internal** × **Archive / Live** (ASSUMED; outline v7 lists this as an open question. Alternative: Notice/Act × Internal/External. Confirm with Rafa before the deck is drawn)
...
> Note: Ashcroft's internal/external is the borrowed axis; the quadrant names are ours. Do not defend the axes, flag them.

## Slide 6 — Positioning: the movement 2×2 (00:18)
...
## Slide 7 — CMM ↔ Kit / Factory / Bridge (00:21)
...
## Slide 10 — Worked example: C3PO (00:30)
...
## Slide 11 — The hard problem (00:32)
...
> Note: end on "public records and interfaces"; the exercise is the first public record.

## Slide 12 — Exercise: your inventory (00:35)
...
## Slide 13 — Second prompt: the two nearest (00:48)
...
## Slide 14 — Awareness check (00:53)
...
## Slide 15 — Async 1 and what is next (00:56)
- Async 1 is three hours (17:00–20:00 UTC), not an evening: pick one inventory item, copy `KIT_TEMPLATE/` to `kits/<my-name>/`, fill `README.md` only — two paragraphs: what job, for whom, what goes in, what comes out. Push. Nothing else
...
> Note: end at 00:59. Sachin `/stop`s the recorder after the last question.
