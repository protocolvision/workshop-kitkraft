...
1. `participants/*/bridges/*.md` (four logs; withdrawn participants have none): *What a human had to supply*, *Request / Response* (stub bridges), *Did it work*, *What a bridge turned out to be*; the `## Log` lines, counting `unblock`.
