...
| 20:49 | 49 | Sachin | listens | Slide 7: round, pinned order; captures sentences | speak (≈40 s each) | `workshop-dev/transcripts/S2/awareness-check.md` | on |
...
Post-session (Sachin, by 21:30): both S2 segments + summaries → `workshop-dev/transcripts/S2/transcript.md`, `summary.md`, `awareness-check.md`; commit `S2: sachin: transcript + summary`. Check one `blocker` line per present participant's `LOG.md`; ping anyone missing. Overnight: watch for async pushes; ping their assigned readers.
