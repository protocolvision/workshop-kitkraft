...
|---|---|---|---|---|---|---|---|
| 20:00 | 00 | Rafa → Sachin | Slide 1: welcome, consent one-liner, S1 tally, sources; "Recording on (KITCRAFT-S2)" in #workshop-kitkraft; hands over at 20:01 | Slide 1, last two lines (kit time; a kit is what stays), straight into slide 2 | harness open at the clone root | — | `/record channel:#kafka name:KITCRAFT-S2` |
| 20:03 | 03 | Sachin | drops the F2F link in #workshop-kitkraft | Slide 2: book factory, Rao → Dixon in intermediates and interface terms | — | — | on |
...
| 20:53 | 53 | Rafa | Slide 8: awareness check; tallies in #workshop-kitkraft | — | one word each | tally | on |
| 20:56 | 56 | Rafa | Slide 9: Async 2; posts text + S3 timing in #workshop-kitkraft | — | — | — | on |
