...
| 20:08 | 08 | Sachin | links `workshop-dev/context-tank/resources.md` §3a | Slide 4: what a factory is — definition, who supplies what, the missing-property table, postponement, fork vs compose, the autonomy dial, job shop | — | — | on |
...
| 20:35 | 35 | Rafa | Slide 7 (60 s); `/stop`; "Recording off · rooms open"; posts the S2 breakout post (`../planning/breakout-instructions.md`); moves people; goes to breakout-1 | goes to the highest-numbered room | move to rooms | — | `/stop` |
