...
**Reference.** [Stigmergy as a universal coordination mechanism (Heylighen)](https://pespmc1.vub.ac.be/Papers/Stigmergy-Springer.pdf) · [Agent Skills specification](https://agentskills.io/specification) · the full rung-by-rung standards table, including AGENTS.md, MCP, A2A, x402 and ERC-8004: `../resources.md` §4
