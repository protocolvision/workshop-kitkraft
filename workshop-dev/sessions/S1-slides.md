...
- What you write down — a folder with a README, a SKILL.md and an example — is that adaptation, in a shape another person's assistant can run. A factory is a kit whose interface has closed for others
