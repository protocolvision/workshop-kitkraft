...
> Note: Sachin reads `consent-notice.md` verbatim; it ends with "Recording starts now". Ask "anyone want to be off-transcript?" and wait two seconds.
...
- 75 seconds each for six people, 45 seconds for ten or more; Sachin posts the order in #kitcraft
> Note: Sachin seeds with his own example; Rafa goes second with water-rate PDFs and the rule "the agent never converts units". Anyone running long is cut at 90 s.
