...
**Examples (15)**
- The Rao–Dixon precedent, in factory terms: intermediates flowing between two job shops; skills as industrial intermediates; high-trust links as the invisible 90%. Rao's factory-to-factory link — two people with significant mutual trust exchanging intermediates between their bespoke infrastructures — is one observed form of what this workshop calls a bridge; whether it is *the* form is what Tuesday finds out.
