...
- Edit only inside `participants/NAME/`. Everything else is read-only for you. One exception: as a stub owner answering a request, you append under `### Response` in the requester's bridge file (`instructions/S3-bridge.md`, second section).
